        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 lg:hidden">
            <button
              ...
              className="p-2 text-[#231F20] hover:text-[#8C201C] rounded-xl transition-colors"
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <button
              onClick={() => setIsSearchOpen(true)}
              className="hidden lg:flex items-center gap-2 bg-[#FFFFFF] hover:border-[#8C201C] text-[#777777] hover:text-[#231F20] border border-[rgba(51,51,51,0.18)] px-3.5 py-1.5 rounded-full text-xs transition-colors"
            ...
            {/* Basket Button: Solid #8C201C with solid #E07A4A badge */}
            <button
              onClick={() => setIsCartDrawerOpen(true)}
              className="relative flex items-center gap-2 bg-[#8C201C] hover:bg-[#6B1815] text-[#FFFFFF] px-3.5 sm:px-4 py-2 rounded-xl transition-all shadow-sm active:scale-95"
              aria-label="Shopping Cart"
            >
              <ShoppingBag className="w-4 h-4 text-[#FFFFFF]" />
              <span className="text-xs font-bold hidden sm:inline text-[#FFFFFF]">Basket</span>
              <span className="w-5 h-5 rounded-full bg-[#E07A4A] text-[#231F20] text-xs font-bold flex items-center justify-center">
                {totalItems}
              </span>
            </button>
          </div>
        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="relative w-4/5 max-w-xs bg-[#FFFFFF] h-full shadow-2xl flex flex-col justify-between border-r border-[rgba(51,51,51,0.10)] animate-in slide-in-from-left duration-200">
            ...
            <div className="p-5 flex items-center justify-between bg-[#8C201C] text-[#FFFFFF]">
              ...
              <button
                onClick={() => setIsMobileMenuOpen(false)}
                className="p-1 text-[#FFFFFF] hover:text-[#E07A4A]"
            ...
            <div className="flex-1 overflow-y-auto py-4 px-4 space-y-1">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="flex items-center justify-between px-3 py-3 rounded-xl text-sm font-semibold text-[#231F20] hover:text-[#8C201C] hover:bg-[#FFF9F3] transition-colors"
                >
            ...
            {/* Footer info */}
            <div className="p-4 bg-[#FFF9F3] border-t border-[rgba(51,51,51,0.10)] text-center">
              <p className="text-[11px] text-[#555555] mb-2">
                Need assistance? Call or WhatsApp us:
              </p>
              <a
                href="tel:+918860488004"
                className="inline-flex items-center gap-1.5 text-xs font-bold text-[#8C201C] hover:text-[#6B1815]"
              >
                <Phone className="w-3.5 h-3.5 text-[#8C201C]" />
                <span>+91 88604 88004</span>
              </a>
            </div>
          </div>
