    ...
    <div className="bg-[#FFFFFF] min-h-screen py-10 sm:py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          <div className="bg-[#FFF9F3] p-5 rounded-2xl border border-[rgba(51,51,51,0.10)] text-center shadow-xs">
            <Truck className="w-6 h-6 text-[#8C201C] mx-auto mb-2" />
            <h4 className="font-serif text-sm font-bold text-[#231F20]">Free Shipping</h4>
            <p className="text-[11px] text-[#555555] font-medium mt-0.5">On all orders above ₹599 across India.</p>
          </div>
          <div className="bg-[#FFF9F3] p-5 rounded-2xl border border-[rgba(51,51,51,0.10)] text-center shadow-xs">
            <Clock className="w-6 h-6 text-[#8C201C] mx-auto mb-2" />
            <h4 className="font-serif text-sm font-bold text-[#231F20]">Fast Dispatch</h4>
            <p className="text-[11px] text-[#555555] font-medium mt-0.5">Orders packed and dispatched in 24-48 hrs.</p>
          </div>
          <div className="bg-[#FFF9F3] p-5 rounded-2xl border border-[rgba(51,51,51,0.10)] text-center shadow-xs">
            <ShieldCheck className="w-6 h-6 text-[#8C201C] mx-auto mb-2" />
            <h4 className="font-serif text-sm font-bold text-[#231F20]">Safe Glass Packing</h4>
            <p className="text-[11px] text-[#555555] font-medium mt-0.5">Multi-layer honeycomb shockproof boxes.</p>
          </div>
          <div className="bg-[#FFF9F3] p-5 rounded-2xl border border-[rgba(51,51,51,0.10)] text-center shadow-xs">
            <MapPin className="w-6 h-6 text-[#8C201C] mx-auto mb-2" />
            <h4 className="font-serif text-sm font-bold text-[#231F20]">19,000+ Pincodes</h4>
        ...
        <div className="bg-[#FFFFFF] p-6 sm:p-10 rounded-3xl border-2 border-[rgba(51,51,51,0.10)] shadow-xs space-y-6 text-xs sm:text-sm text-[#231F20] font-medium leading-relaxed">
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8C201C]">1. Shipping Charges</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8C201C]">2. Delivery Timelines</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8C201C]">3. Multi-Layer Protective Glass Packaging</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8C201C]">4. Tracking Your Order</h2>
            <p>
              Once your shipment is handed over to our logistics partner (BlueDart, Delhivery, or Xpressbees), you will receive a tracking link via SMS and WhatsApp. You can also track your live shipment anytime on our <Link href="/track-order" className="text-[#8C201C] font-bold underline">Order Tracking Page</Link>.
            </p>
          </section>

          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8C201C]">5. Queries &amp; Support</h2>
            <p>
              For any urgent address corrections or delivery rescheduling, please WhatsApp our support desk at <a href={BRAND_INFO.whatsappUrl} className="text-[#8C201C] font-bold underline">+91 88604 88004</a> or email <a href={`mailto:${BRAND_INFO.email}`} className="text-[#8C201C] font-bold underline">{BRAND_INFO.email}</a>.
            </p>
          </section>
        </div>
      </div>
