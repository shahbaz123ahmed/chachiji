      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-[#FFFFFF] p-6 sm:p-10 rounded-3xl border-2 border-[rgba(51,51,51,0.10)] shadow-xs space-y-6 text-xs sm:text-sm text-[#333333] font-medium leading-relaxed">
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8B3E3E]">1. Information We Collect</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8B3E3E]">2. Payment Processing Security</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8B3E3E]">3. Data Sharing with Courier Partners</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8B3E3E]">4. Contact Our Data Representative</h2>
            <p>
              If you wish to update or delete your customer account information, please email our support desk at <a href={`mailto:${BRAND_INFO.email}`} className="text-[#8B3E3E] font-bold underline">{BRAND_INFO.email}</a>.
            </p>
          </section>
        </div>
      </div>
