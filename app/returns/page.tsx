    ...
    <div className="bg-[#FFFFFF] min-h-screen py-10 sm:py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
          <div className="bg-[#FCE9D6] p-6 rounded-2xl border border-[rgba(51,51,51,0.10)] text-center shadow-xs">
            <span className="w-8 h-8 rounded-full bg-[#8B3E3E] text-[#FFFFFF] text-xs font-bold flex items-center justify-center mx-auto mb-3">
              1
            </span>
            <h4 className="font-serif text-base font-bold text-[#333333]">Share Photo / Video</h4>
          ...
          <div className="bg-[#FCE9D6] p-6 rounded-2xl border border-[rgba(51,51,51,0.10)] text-center shadow-xs">
            ...
            <h4 className="font-serif text-base font-bold text-[#333333]">Instant Kitchen Review</h4>
          ...
          <div className="bg-[#FCE9D6] p-6 rounded-2xl border border-[rgba(51,51,51,0.10)] text-center shadow-xs">
            ...
            <h4 className="font-serif text-base font-bold text-[#333333]">Free Re-Dispatch or Refund</h4>
        ...
        <div className="bg-[#FFFFFF] p-6 sm:p-10 rounded-3xl border-2 border-[rgba(51,51,51,0.10)] shadow-xs space-y-6 text-xs sm:text-sm text-[#333333] font-medium leading-relaxed">
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8B3E3E]">1. Food Safety &amp; Return Eligibility</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8B3E3E]">2. How to Claim a Replacement</h2>
            <p>
            ...
            <ol className="list-decimal pl-5 space-y-1 text-xs">
              ...
              <li>WhatsApp the photos along with your Order ID to <a href={BRAND_INFO.whatsappUrl} className="text-[#8B3E3E] font-bold underline">+91 88604 88004</a>.</li>
          ...
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8B3E3E]">3. Cancellation Policy</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8B3E3E]">4. Refund Processing Time</h2>
            <p>
