    ...
    <div className="bg-[#FFFFFF] min-h-screen py-10 sm:py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-xl mx-auto mb-10">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-[#333333] mt-1 mb-2">
            Track Your Shipment
          </h1>
        ...
        <div className="bg-[#FCE9D6] p-6 sm:p-8 rounded-3xl border border-[rgba(51,51,51,0.10)] shadow-sm mb-8">
          <form onSubmit={handleSearch} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#FFFFFF] border border-[rgba(51,51,51,0.18)] rounded-xl px-4 py-2.5 text-xs text-[#333333] font-bold uppercase focus:outline-none focus:border-[#8B3E3E]"
                />
              </div>
              <div>
                <label className="block text-xs font-bold text-[#333333] mb-1">
                ...
                <input
                  ...
                  className="w-full bg-[#FFFFFF] border border-[rgba(51,51,51,0.18)] rounded-xl px-4 py-2.5 text-xs text-[#333333] font-semibold focus:outline-none focus:border-[#8B3E3E]"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-[#8B3E3E] hover:bg-[#733232] text-[#FFFFFF] font-bold text-xs sm:text-sm py-3.5 rounded-xl transition-all shadow-md flex items-center justify-center gap-2"
            >
        ...
        {searched && (
          <div className="bg-[#FFFFFF] rounded-3xl border-2 border-[rgba(51,51,51,0.10)] p-6 sm:p-10 shadow-md space-y-8 animate-in fade-in">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[rgba(51,51,51,0.10)] pb-6 text-xs">
              <div>
                <span className="text-[10px] uppercase font-bold tracking-wider text-[#8B3E3E]">
                  Tracking Summary
                </span>
                <h3 className="font-serif text-2xl font-bold text-[#333333] mt-0.5">
              ...
              <div className="bg-[#F7A77A] text-[#333333] px-4 py-2 rounded-xl font-bold text-xs self-start sm:self-auto shadow-2xs">
            ...
            <div className="space-y-6 relative pl-6 before:absolute before:left-2.5 before:top-2 before:bottom-2 before:w-0.5 before:bg-[rgba(51,51,51,0.12)]">
              ...
              <div className="relative">
                <div className="absolute -left-6 top-0.5 w-5 h-5 rounded-full bg-[#8B3E3E] text-[#FFFFFF] flex items-center justify-center">
                  <CheckCircle2 className="w-4 h-4" />
                </div>
                <div className="text-xs">
                  <span className="font-bold text-[#333333] block text-sm">Order Received &amp; Verified</span>
              ...
              <div className="relative">
                ...
                <div className="text-xs">
                  <span className="font-bold text-[#333333] block text-sm">Artisan Packaged with Glass Protection</span>
              ...
              {/* Step 3 (Active) */}
              <div className="relative">
                <div className="absolute -left-6 top-0.5 w-5 h-5 rounded-full bg-[#8B3E3E] text-[#FFFFFF] flex items-center justify-center animate-pulse">
                  <Truck className="w-3.5 h-3.5 text-[#F7A77A]" />
                </div>
                <div className="text-xs">
                  <span className="font-bold text-[#8B3E3E] block text-sm">In Transit via Express Air</span>
              ...
              <div className="relative opacity-40">
                ...
                <div className="text-xs">
                  <span className="font-bold text-[#333333] block text-sm">Out for Delivery</span>
            ...
            {/* Help box */}
            <div className="bg-[#FCE9D6] p-4 rounded-2xl border border-[rgba(51,51,51,0.10)] flex items-center justify-between text-xs">
              <span className="text-[#333333] font-medium">Need assistance with delivery location or rescheduling?</span>
              <a
                href={BRAND_INFO.whatsappUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#8B3E3E] font-bold hover:underline"
              >
