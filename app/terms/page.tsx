      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-[#FFFFFF] p-6 sm:p-10 rounded-3xl border-2 border-[rgba(51,51,51,0.10)] shadow-xs space-y-6 text-xs sm:text-sm text-[#231F20] font-medium leading-relaxed">
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8C201C]">1. Small-Batch Handcrafted Variations</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8C201C]">2. Pricing &amp; Order Acceptance</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8C201C]">3. Food Storage Responsibility</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="font-serif text-xl font-bold text-[#8C201C]">4. Legal Jurisdiction</h2>
            <p>
